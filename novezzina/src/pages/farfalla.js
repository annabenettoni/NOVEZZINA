...
function Farfalla() {
    const testi = [
        "Ecco dove eravate, mi avete trovata! Io sono la Farfalla Lalla. Avete visto che belli questi fiori? Sono orchidee, ed ogni petalo racchiude un segreto che solo il vento conosce.",
        "Non sono solo belle e rare, ma sono anche delle specie protette che crescono in svariati ambienti come prati aridi, margini bosco e pascoli montani.",
    ...
    return (
        <div id='position-spiegazione'>
            <Vignetta
                ...
                id="testo"
            />
            <Buttons animale="castoro" testi={testi} indiceTestoCorrente={indiceTestoCorrente} setIndiceTestoCorrente={setIndiceTestoCorrente} />
        </div>
    );
}

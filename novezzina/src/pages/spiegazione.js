...
export default function Spiegazione() {
    const testi = [
        ...
        "Ora che conoscete le regole del gioco, è tempo di metterle in pratica! Seguite il profumo dolce delle rose che si diffonde nell'aria e dirigetevi verso di esse, la mia carissima amica gialla e nera pronta ad aspettarvi. Buona fortuna, piccoli esploratori, e che l'avventura abbia inizio!"
    ];
